...
public interface FeignHttpClient {
    ...
    DatasetsAttachmentFeignClient getDatasetsAttachmentFeignClient();

    DatasetsAttributeFeignClient getDatasetsAttributeFeignClient();

    DatasetsDatasetFeignClient getDatasetsDatasetFeignClient();

    DatasetsDatasetListFeignClient getDatasetsDatasetListFeignClient();

    DatasetsVisibilityAreaFeignClient getDatasetsVisibilityAreaFeignClient();

    BvTestCaseResourceFeignClient getBvTestCaseResourceFeignClient();

    BvPublicApiResourceFeignClient getBvPublicApiResourceFeignClient();

    BvApiResourceFeignClient getBvApiResourceFeignClient();
}
