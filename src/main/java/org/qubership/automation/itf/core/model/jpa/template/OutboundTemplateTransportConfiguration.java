...
package org.qubership.automation.itf.core.model.jpa.template;
...
public class OutboundTemplateTransportConfiguration extends Configuration {
    ...
    public OutboundTemplateTransportConfiguration() {
        super();
    }

    public OutboundTemplateTransportConfiguration(String type, Template parent) {
        super(type);
        setParent(parent);
    }
    ...
    @SuppressFBWarnings(value = "BC_UNCONFIRMED_CAST", justification = "Only Template objects are here")
