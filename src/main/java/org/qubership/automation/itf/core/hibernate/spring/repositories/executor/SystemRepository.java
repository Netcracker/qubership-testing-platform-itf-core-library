...
public interface SystemRepository extends StorableRepository<System> {
    ...
    @NativeQuery("select distinct s_labels.labels as labels "
    ...
    @NativeQuery("select ec_project_id from mb_systems "
    ...
    @Modifying
    @NativeQuery("update mb_systems set ec_project_id = null, ec_id = null, ec_label = null "
