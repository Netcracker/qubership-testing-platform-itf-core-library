...
@Getter
@Setter
public class EventTriggerStateResponse extends TriggerStateResponse {

    public EventTriggerStateResponse(Map<BigInteger, TriggerState> states, String errorMessage,
