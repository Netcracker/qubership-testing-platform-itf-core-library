...
public class KeyHelper {
    public static String defineKey(String macro, InstanceContext context, Storable parent)
            throws KeyDefinitionException {
        return TemplateEngineFactory.process(parent, macro, context).trim();
    }

    public static String defineKey(String macro, InstanceContext context) throws KeyDefinitionException {
