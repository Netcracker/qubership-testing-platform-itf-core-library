...
public abstract class ParametersInterceptor extends TransportInterceptor {
    public ParametersInterceptor() {
    }

    public ParametersInterceptor(Interceptor interceptor) {
        super(interceptor);
    }

    public abstract List<InterceptorPropertyDescriptor> getParameters(List<PropertyDescriptor> redefinedProperties);
}
