...
public class LoaderInboundTransportImpl extends LoaderBaseTransportImpl<InboundTransport>
        implements AccessInboundTransport {

    public LoaderInboundTransportImpl(InboundTransport transport) {
        super(transport);
    }
}
