...
public interface EngineAfterIntegration extends EngineIntegration {

    void executeAfter(CallChainInstance callchainInstance, IntegrationConfig integrationConf)
