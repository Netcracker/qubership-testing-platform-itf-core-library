...
public class ServerTriggerStateResponse extends TriggerStateResponse {

    public ServerTriggerStateResponse(Map<BigInteger, TriggerState> states, String errorMessage,
                                      StubUser user, String sessionId) {
        super(states, errorMessage, user, sessionId);
    }
