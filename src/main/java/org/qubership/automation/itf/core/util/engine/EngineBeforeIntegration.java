...
public interface EngineBeforeIntegration extends EngineIntegration {

    void executeBefore(CallChainInstance callchainInstance, IntegrationConfig integrationConf)
