...
package org.qubership.automation.itf.core.model.project;
...
public class ProjectSettings extends Configuration {
     ...
     */
    public ProjectSettings(Map<String, String> param) {
        if (param != null) {
            putAll(param);
        }
        setTypeName(ProjectSettingsDescriptor.class.getName());
    }
